...
class LammpsData():
    ...
    def from_structure(cls, structure, params):
        ...
        potentials = buckingham_potentials(params, atom_types)
...
def buckingham_potentials(params, atom_types):
    """
    ...
    for key, item in params['bpp'].items():
        ...
        potentials.append(BuckinghamPotentials(atom_type_1=atom_name_1,
                                               atom_type_2=atom_name_2,
                                               atom_type_index_1=atom_type_index_1,
                                               atom_type_index_2=atom_type_index_2,
                                               a = item[0],
                                               rho=item[1],
                                               c=item[2]))
...
class BuckinghamPotentials():
    
    def __init__(self, atom_type_1, atom_type_2, atom_type_index_1, atom_type_index_2, a, rho, c):
        """
        Initialise buchingham potentials.
        ...
        Returns:
            None
        """
        self.label_1 = atom_type_1
        self.label_2 = atom_type_2
        self.atype_1 = atom_type_index_1
        self.atype_2 = atom_type_index_2
        self.a = a
        self.rho = rho
        self.c = c
    ...
    def potential_string(self):
        ...
        Returns:
            return_str (str): 
        """
        return_str = 'pair_coeff {} {} {} {} {}'.format(self.atype_1, self.atype_2, self.a, self.rho, self.c)
        return return_str
    
    def name_string(self):
        return '{}_{}'.format(self.label_1, self.label_2)
    

    def update(self, name=None, value=None):
        if name is None or value is None:
            raise ArgumentError("You have not passes a variable name or value")
        self.a = value
