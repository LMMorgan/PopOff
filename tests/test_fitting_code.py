...
@patch('popoff.fitting_code.pot', autospec=True) 
@patch('popoff.fitting_code.collate_structural_data', autospec=True)   
...
@patch('popoff.lammps_data.LammpsData.core_mask', autospec=True) 
...
@patch('popoff.fitting_code.FitModel._update_charge_scaling')
@patch('popoff.fitting_code.FitModel._update_potentials')                        
@patch('popoff.fitting_code.FitModel._update_springs')                        
@patch('popoff.fitting_code.FitModel._update_q_ratio') 
@patch('popoff.fitting_code.FitModel._charge_reset')    
...
@patch('popoff.fitting_code.FitModel.expected_stresses') 
@patch('popoff.fitting_code.FitModel.expected_forces')     
@patch('popoff.fitting_code.FitModel.get_forces_and_stresses')  
@patch('popoff.fitting_code.FitModel.init_potential')     
...
@patch('popoff.fitting_code.os.system')
