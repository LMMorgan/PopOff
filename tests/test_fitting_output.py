...
from popoff.fitting_output import (create_directory,
...
@patch('popoff.fitting_output.os.path.isdir')
@patch('popoff.fitting_output.os.makedirs')
...
@patch('popoff.fitting_output.json.dump')
@patch('builtins.open', new_callable=mock_open)
@patch('popoff.fitting_output.np.savetxt')
