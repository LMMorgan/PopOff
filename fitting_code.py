...
class FitModel():
    ...
    @classmethod
    def collect_info(cls, params,  supercell=None):
        """
        ...
        potentials = pot.buckingham_potentials(params['potentials'], lammps_data[0].atom_types, parameters) #REWRITE TO READ ATOM_TYPES WITHOUT [0]
