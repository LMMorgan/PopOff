...
from collate_structures import collate_structural_data, data_from_vasprun
...
def test_asserts_for_data_from_vasprun(params):
...
@mock.patch('collate_structures.data_from_vasprun', autospec=True)
def test_output_in_collate_structural_data(mock_data_from_vasprun, params, atom_types):
    mock_lammps_data = [mock.Mock(spec=LammpsData), mock.Mock(spec=LammpsData)]
