...
if __name__ == '__main__':
    ...
    bounds_list = [ (100.0,50000.0),(0.01,1.0), (100.0,50000.0),(0.01,1.0), (150.0,50000.0),(0.01,1.0)]

    tot_num_structures = 15
    num_struct_to_fit = 5
    num_of_fits = 1
    head_directory_name = 'final_potentials/formal+ri'.format(num_struct_to_fit)
