...
def create_directory(head_directory_name, local_struct_dir):
    ...
    Returns:
        str: directory pathway to output directory.
    """
...
def extract_stresses_and_forces(fit_data, values, args):
    ...
    Returns:
        np.array, np.array, np.array, np.array: 3D array of dft forces in x,y,z for each atom in each structure; 3D array of fitted interatomic potential forces in x,y,z for each atom in each structure; 3D array of dft stress tensors in each structure; 3D array of fitted interatomic potential stress tensors in each structure.
    """
